# unit-4-game # jQuery Assignment - Option One: CrystalsCollector Game

### Game Overview

Assignment was to create a crystals collector game.  Instead of crystals I used Marvel
characters as my buttons to press.  The concept of the game is that the computer generates
a random # and there are button that have numbers in them that you press to try and match
the computer generated number.  If you match the generated number, you win. If you go beyond the number you lose.

Everytime you start the game the numbers within the button get randomly set so that the
value of each button is different everytime a new game starts.
